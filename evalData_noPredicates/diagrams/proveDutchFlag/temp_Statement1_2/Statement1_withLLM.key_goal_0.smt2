...
(assert (distinct sort_Null sort_Heap sort_Field sort_java.lang.Object |sort_int[]| sort_int sort_boolean sort_any))
...
(assert (instanceof u_t_old sort_int))
(assert (instanceof u_t sort_int))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((var_q Int)) (or (not (and (>= var_q 0) (< var_q 0))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) (i2u 0)))) (forall ((var_q Int)) (or (not (and (>= var_q 0) (< var_q 0))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) (i2u 1))))) (forall ((var_q Int)) (or (not (and (>= var_q (u2i (k_length u_A))) (< var_q (u2i (k_length u_A))))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) (i2u 2))))) (<= 0 0)) (<= 0 0)) (<= 0 (u2i (k_length u_A)))) (<= (u2i (k_length u_A)) (u2i (k_length u_A)))) (not (= u_A k_null))) (> (u2i (k_length u_A)) 0)) (<= 0 (u2i u_wb))) (<= (u2i u_wb) (u2i u_wt))) (<= (u2i u_wt) (u2i u_bb))) (<= (u2i u_bb) (u2i (k_length u_A)))) (forall ((var_i Int)) (=> (and (>= var_i 0) (< var_i (u2i (k_length u_A)))) (or (or (= (cast (k_select u_heap u_A (arr (i2u var_i))) sort_int) (i2u 0)) (= (cast (k_select u_heap u_A (arr (i2u var_i))) sort_int) (i2u 1))) (= (cast (k_select u_heap u_A (arr (i2u var_i))) sort_int) (i2u 2)))))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A_old |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_A_old u_A) (u_t_old u_t)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  wb = 0;  wt = 0;  bb = A.length;}\> (and(and(and(and(and(and(and(and(all{q:int}(or(not(and(geq(q,Z(0(#))),lt(q,wb))),equals(int::select(heap,A,arr(q)),Z(0(#))))),all{q:int}(or(not(and(geq(q,wb),lt(q,wt))),equals(int::select(heap,A,arr(q)),Z(1(#)))))),all{q:int}(or(not(and(geq(q,bb),lt(q,length(A)))),equals(int::select(heap,A,arr(q)),Z(2(#)))))),leq(Z(0(#)),wb)),leq(wb,wt)),leq(wt,bb)),leq(bb,length(A))),equals(A,A_old)),equals(t,t_old)))
