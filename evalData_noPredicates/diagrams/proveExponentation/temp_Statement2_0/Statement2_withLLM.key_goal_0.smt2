...
(assert (distinct sort_boolean sort_Null sort_Heap sort_Field sort_java.lang.Object sort_int sort_any))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (and (and (= (i2u (* (u2i u_z) (u2i (|u_Helper::pow| u_heap u_b u_i)))) (|u_Helper::pow| u_heap u_a u_n)) (not (= u_i (i2u 0)))) (= (u_mod u_i (i2u 2)) (i2u 0))) (> (u2i u_n) 0)) (> (u2i u_a) 0)) (< (u2i u_n) 6)) (< (u2i u_a) 6)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i u_n))) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_n_old u_n) (u_a_old u_a)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  b = b * b;  i = i / 2;}\> (and(and(equals(mul(z,Helper::pow(heap,b,i)),Helper::pow(heap,a,n)),equals(n,n_old)),equals(a,a_old)))
