...
(assert (distinct sort_boolean sort_Null sort_java.lang.Object sort_any sort_Heap sort_Field sort_int))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (> (u2i u_n) 0) (> (u2i u_n) 0)) (> (u2i u_a) 0)) (< (u2i u_n) 6)) (< (u2i u_a) 6)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i u_n))) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_n_old u_n) (u_a_old u_a)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  i = 0;  z = Helper.pow(a, n);}\> (and(and(equals(mul(z,Helper::pow(heap,b,i)),Helper::pow(heap,a,n)),equals(n,n_old)),equals(a,a_old)))
