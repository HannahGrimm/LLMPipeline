...
(assert (distinct sort_Heap sort_Null sort_int sort_boolean sort_Field sort_any sort_java.lang.Object))
...
; unknown_0 :  \<{  i = i;}\> (and(and(equals(mul(z,Helper::pow(heap,b,i)),Helper::pow(heap,a,n)),equals(n,n_old)),equals(a,a_old)))
