...
(assert (distinct sort_boolean sort_Null sort_Heap sort_Field sort_java.lang.Object sort_any sort_int))
...
; unknown_0 :  \<{  b = a;  i = n;  z = 1;}\> (and(and(equals(mul(z,Helper::pow(heap,b,i)),Helper::pow(heap,a,n)),equals(n,n_old)),equals(a,a_old)))
