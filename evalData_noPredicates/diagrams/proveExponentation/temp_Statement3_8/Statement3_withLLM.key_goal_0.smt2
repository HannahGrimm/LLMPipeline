...
(assert (distinct sort_Null sort_Heap sort_any sort_int sort_boolean sort_Field sort_java.lang.Object))
...
; unknown_0 :  \<{  ;}\> (and(and(equals(mul(z,Helper::pow(heap,b,i)),Helper::pow(heap,a,n)),equals(n,n_old)),equals(a,a_old)))
