...
(declare-const |sort_int[]| T)
(assert (distinct sort_int sort_any sort_Field sort_Heap sort_java.lang.Object sort_boolean sort_Null |sort_int[]|))
...
; unknown_0 :  \<{  i = i;}\> (and(and(all{q:int}(or(not(and(geq(q,Z(0(#))),lt(q,add(j,Z(1(#)))))),geq(int::select(heap,A,arr(i)),int::select(heap,A,arr(q))))),equals(j,j_old)),equals(A,A_old)))
