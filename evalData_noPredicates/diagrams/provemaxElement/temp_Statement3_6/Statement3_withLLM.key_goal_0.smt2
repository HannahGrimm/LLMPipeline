...
(assert (distinct sort_boolean sort_Heap sort_Field sort_int |sort_int[]| sort_java.lang.Object sort_any sort_Null))
...
; unknown_0 :  \<{  j = j - 1;}\> (and(all{q:int}(or(not(and(geq(q,Z(0(#))),lt(q,add(j,Z(1(#)))))),geq(int::select(heap,A,arr(i)),int::select(heap,A,arr(q))))),equals(A,A_old)))
