...
(assert (distinct sort_java.lang.Object sort_any sort_Null |sort_int[]| sort_Field sort_int sort_Heap sort_boolean))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((var_q Int)) (or (not (and (>= var_q 0) (< var_q (+ (u2i u_j) 1)))) (>= (u2i (cast (k_select u_heap u_A (arr u_i)) sort_int)) (u2i (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int))))) (= u_variantVar0 (i2u (- (u2i (k_length u_A)) (u2i u_j))))) (not (= u_A k_null))) (> (u2i (k_length u_A)) 0)) (< (u2i (k_length u_A)) 10)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i (k_length u_A)))) (>= (u2i u_j) 0)) (<= (u2i u_j) (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A_old |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_A_old u_A)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  {    j = j + 1;  }}\> (and(and(all{q:int}(or(not(and(geq(q,Z(0(#))),lt(q,j))),geq(int::select(heap,A,arr(i)),int::select(heap,A,arr(q))))),gt(variantVar0,sub(length(A),j))),equals(A,A_old)))
