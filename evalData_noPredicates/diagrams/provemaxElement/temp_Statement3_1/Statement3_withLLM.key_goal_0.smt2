...
(declare-const |sort_int[]| T)
(assert (distinct sort_boolean sort_java.lang.Object sort_Heap sort_Null sort_any sort_int sort_Field |sort_int[]|))
...
; unknown_0 :  \<{  i = j;}\> (and(all{q:int}(or(not(and(geq(q,Z(0(#))),lt(q,add(j,Z(1(#)))))),geq(int::select(heap,A,arr(i)),int::select(heap,A,arr(q))))),equals(A,A_old)))
