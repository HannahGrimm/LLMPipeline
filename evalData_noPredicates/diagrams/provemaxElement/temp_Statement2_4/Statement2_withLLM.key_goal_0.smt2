...
(assert (distinct |sort_int[]| sort_Heap sort_boolean sort_java.lang.Object sort_Null sort_any sort_int sort_Field))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (and (and (and (and (and (> (u2i (k_length u_A)) 0) (= u_i (i2u 0))) (not (= u_A k_null))) (> (u2i (k_length u_A)) 0)) (< (u2i (k_length u_A)) 10)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i (k_length u_A)))) (>= (u2i u_j) 0)) (<= (u2i u_j) (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A_old |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_A_old u_A)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  j = 1;}\> (and(and(and(gt(length(A),Z(0(#))),equals(i,Z(0(#)))),equals(j,Z(1(#)))),equals(A,A_old)))
