...
(declare-const |sort_int[]| T)
(assert (distinct sort_boolean sort_Field sort_int sort_java.lang.Object sort_Heap sort_Null sort_any |sort_int[]|))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (and (and (and (and (and (not (exists ((var_q Int)) (and (and (>= var_q (+ (u2i u_i) 1)) (< var_q (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) u_x)))) (not (= (cast (k_select u_heap u_A (arr u_i)) sort_int) u_x))) (= u_variantVar0 u_i)) (not (= u_A k_null))) (> (u2i (k_length u_A)) 0)) (< (u2i (k_length u_A)) 10)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i (k_length u_A)))) (exists ((var_q Int)) (and (and (>= var_q 0) (< var_q (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) u_x)))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A_old |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_x_old u_x) (u_A_old u_A)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  i = i - 1;}\> (and(and(and(not(exists{q:int}(and(and(geq(q,add(i,Z(1(#)))),lt(q,length(A))),equals(int::select(heap,A,arr(q)),x)))),gt(variantVar0,i)),equals(x,x_old)),equals(A,A_old)))
