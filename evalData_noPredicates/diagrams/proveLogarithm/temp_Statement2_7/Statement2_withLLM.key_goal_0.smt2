...
(assert (distinct sort_int sort_Null sort_Heap sort_any sort_java.lang.Object sort_Field sort_boolean))
...
; unknown_0 :  \<{  ;}\> (and(and(geq(N,mul(n,Helper::pow(heap,Z(2(#)),l))),lt(N,mul(add(n,Z(1(#))),Helper::pow(heap,Z(2(#)),l)))),equals(N,N_old)))
