...
(assert (distinct sort_int sort_Null sort_java.lang.Object sort_Field sort_any sort_Heap sort_boolean))
...
; unknown_0 :  \<{  n = n;}\> (and(and(geq(N,mul(n,Helper::pow(heap,Z(2(#)),l))),lt(N,mul(add(n,Z(1(#))),Helper::pow(heap,Z(2(#)),l)))),equals(N,N_old)))
