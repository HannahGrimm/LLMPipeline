...
(assert (distinct sort_int sort_Null sort_Field sort_java.lang.Object sort_Heap sort_boolean sort_any))
...
; unknown_0 :  \<{  n = n;  l = l;}\> (and(and(geq(N,mul(n,Helper::pow(heap,Z(2(#)),l))),lt(N,mul(add(n,Z(1(#))),Helper::pow(heap,Z(2(#)),l)))),equals(N,N_old)))
