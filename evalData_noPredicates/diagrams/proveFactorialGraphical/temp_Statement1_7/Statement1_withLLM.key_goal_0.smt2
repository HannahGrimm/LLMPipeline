...
(assert (distinct sort_Field sort_int sort_Null sort_any sort_boolean sort_Heap sort_java.lang.Object))
...
; --- Sequent
(assert (not (=> (and (and (and (and (>= (u2i u_n) 0) (= u_n (i2u 0))) (>= (u2i u_n) 0)) (< (u2i u_n) 6)) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_n_old u_n)) unknown_0)))))
